 ...
 */
final class Version20240715192858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE esp_saison_classe (code_cl INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(code_cl)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
