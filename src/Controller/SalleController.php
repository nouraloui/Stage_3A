...
class SalleController extends AbstractController
{
    ...
    #[Route('/{code_salle}', name: 'app_salle_show', methods: ['GET'])]
    ...
    #[Route('/{code_salle}/edit', name: 'app_salle_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{code_salle}', name: 'app_salle_delete', methods: ['POST'])]
    public function delete(Request $request, Salle $salle, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$salle->getCodeSalle(), $request->request->get('_token'))) {
