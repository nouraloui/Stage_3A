 ...
 */
final class Version20240831140715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE esp_saison_classe (id INT AUTO_INCREMENT NOT NULL, annee_deb VARCHAR(10) NOT NULL, date_demarrage DATE NOT NULL, description VARCHAR(300) NOT NULL, code_cl VARCHAR(10) NOT NULL, nb_etudiant INT NOT NULL, salle_principale VARCHAR(2) NOT NULL, salle_secondaire_1 VARCHAR(3) NOT NULL, salle_secondaire_2 VARCHAR(3) NOT NULL, nature VARCHAR(1) NOT NULL, type_classe VARCHAR(2) NOT NULL, nb_seance INT NOT NULL, classe_entreprise VARCHAR(1) NOT NULL, semestre INT NOT NULL, cl_eclate VARCHAR(1) NOT NULL, INDEX IDX_E084358FDD948132 (annee_deb), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE esp_saison_universitaire (annee_deb VARCHAR(255) NOT NULL, description VARCHAR(4) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, observation VARCHAR(500) NOT NULL, PRIMARY KEY(annee_deb)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE esp_saison_classe ADD CONSTRAINT FK_E084358FDD948132 FOREIGN KEY (annee_deb) REFERENCES esp_saison_universitaire (annee_deb)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE esp_saison_classe DROP FOREIGN KEY FK_E084358FDD948132');
