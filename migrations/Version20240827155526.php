 ...
 */
final class Version20240827155526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photos_etudiant (id INT AUTO_INCREMENT NOT NULL, id_et_id INT NOT NULL, photos_id LONGBLOB NOT NULL, UNIQUE INDEX UNIQ_721D2FC42865F9 (id_et_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
